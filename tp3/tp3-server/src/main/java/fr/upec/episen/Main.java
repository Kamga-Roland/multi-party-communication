    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try (DatagramSocket socket = new DatagramSocket()) {
                ...
                while (count < nbMsg) {
                    String message = "I am a multicast server!";
                    ...
                    DatagramPacket dp = new DatagramPacket(buffer, buffer.length, group,
                            Integer.parseInt(properties.getProperty("udp.server.port")));
                    socket.send(dp);
